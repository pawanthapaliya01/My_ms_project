...
! > gfortran -O3 parameters.o pb_force.f90 -o pb_force.out
! execute:
! ./pb_force.out
...
! Output to Files
           ...
           open(14,file='l_force.dat',position='append')
               write(14,*) ll(:)
               write(14,*)
           close(14)
           open(15,file='f_force.dat',position='append')
               write(15,*) ff(:)
               write(15,*)
           close(15)
           open(16,file='y_force.dat',position='append')
               write(16,*) yy(:)
               write(16,*)
           close(16)
           open(17,file='theta_force.dat',position='append')
               write(17,*) qq(:)
               write(17,*)
           close(17)
           open(18,file='h_force.dat',position='append')
               write(18,*) hh(:)
               write(18,*)
           close(18)
           open(19,file='nbub_force.dat',position='append')
               write(19,*) nn(:)
               write(19,*)
           close(19)
           open(20,file='bubsize_force.dat',position='append')
               write(20,*) xx(:)
               write(20,*)
           close(20)    
